...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="contactForm">
        ...
        <div>
            <asp:TextBox ID="txtName" placeholder="Your name" label="txtName" runat="server"></asp:TextBox>
        </div>
        <div class="warning">
        ...
        <div>
            <asp:TextBox ID="txtEmail" placeholder="Your valid email address" label="txtEmail" runat="server"></asp:TextBox>
        </div>
        <div class="warning">
        ...
        <div>
            <asp:TextBox ID="txtSubject" placeholder="Your subject" label="txtSubject" runat="server"></asp:TextBox>
        </div>
        <div class="warning">
        ...
        <div>
            <asp:TextBox ID="txtMessage" placeholder="Your message" label="txtMessage" runat="server" TextMode="MultiLine"></asp:TextBox>
        </div>
        <div class="warning">
